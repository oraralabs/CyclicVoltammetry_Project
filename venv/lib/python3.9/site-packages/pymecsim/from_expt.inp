...
0	! 0 = E_start=E_end, 1 = use advanced ramp below, 2=From file "EInput.txt"
2	! Not used 
0.0	!Not used E_start (V) 
0.0	! Not use E_end (V) 
0.50	! Not used E_rev - REPEAT for more complicated ramps 
-0.50	! Not used E_rev - REPEAT for more complicated ramps 
1	! Geometry type
1.00e+00	! planar_surface_area 
1.00e+00	! num_spheres 
1.00e-04	! r_sphere 
5.00e-01	! num_cylinders 
1.00e-03	! r_cylinder 
1.00e-01	! l_cylinder 
100	! cylinder_resolution 
1.00e-01	! r_RDE 
1.00e+02	! v_RDE 
1.00e-05	! nu_RDE 
...
4	! Number of species 
1.00e-06, 1.00e-05, 0 ! A 
0.00e+00, 1.00e-05, 0 ! B 
0.00e+00, 1.00e-05, 0 ! C 
0.00e+00, 1.00e-05, 0 ! D 
3 ! Number of terms
0 ! E_pzc (V)
0 ! a_0
0 ! a_1
0 ! a_2
0 ! a_3
0, -1, 1, 0, 0, 0.0e0, 0.0e0, 0.00e+00, 1.00e+01, 5.00e-01	!Charge Transfer : 1 A + 1 e <=> 1 B
2, 1, -1, -1, 1, 1.00e+08, 1.00e-05, 0.0e0, 0.0e0, 0.50	!Chemical Reaction : 1 B + 1 C <=> 1 A + 1 D
